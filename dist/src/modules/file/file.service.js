    ...
    imageKitMulterStorage() {
        const imageKitStorage = {
            _handleFile: (req, file, cb) => {
                (0, nodejs_1.toFile)(file.stream)
                    .then((fileData) => this.imagekit.files
                    .upload({
                    file: fileData,
...
exports.FileService = FileService = __decorate([
    ...
    __param(0, (0, common_1.Inject)(imagekit_provider_1.imageKitToken)),
    __metadata("design:paramtypes", [nodejs_1.default])
], FileService);
